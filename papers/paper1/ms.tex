...
\begin{figure}
  \gridline{\fig{figures/Kepler_contrast.png}{0.3\textwidth}{(a)}}
  \gridline{\fig{figures/TESS_contrast.png}{0.3\textwidth}{(b)}}
  \gridline{\fig{one_minus_ratio.png}{0.3\textwidth}{(c)}}
