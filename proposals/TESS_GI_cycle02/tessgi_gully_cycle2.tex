...
$$ \frac{A_{TESS}}{A_{Kepler}} = \cancel{\frac{\Delta f_{spot}}{\Delta f_{spot}}} \cdot \frac{1-c_{TESS}}{1-c_{Kepler}} \label{eqn1}$$

\subsection{Measuring Kepler/K2 and TESS amplitudes: Statistical samples}
We see \ref{eqn1} above.
\subsection{Measuring Kepler/K2 and TESS amplitudes: The Kepler Prime Field}
...
Rapid rotators tend to exhibit larger amplitudes of lightcurve undulations than slower rotators.
